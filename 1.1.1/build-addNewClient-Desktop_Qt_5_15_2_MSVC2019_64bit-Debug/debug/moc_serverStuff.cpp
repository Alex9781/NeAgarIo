...
#include <memory>
#include "../../addNewClient/serverStuff.h"
...
QT_MOC_LITERAL(4, 32, 18), // "ClientDisconnected"
QT_MOC_LITERAL(5, 51, 13), // "newConnection"
QT_MOC_LITERAL(6, 65, 10), // "readClient"
QT_MOC_LITERAL(7, 76, 16), // "gotDisconnection"
QT_MOC_LITERAL(8, 93, 12), // "sendToClient"
QT_MOC_LITERAL(9, 106, 11), // "QTcpSocket*"
QT_MOC_LITERAL(10, 118, 6), // "socket"
QT_MOC_LITERAL(11, 125, 3) // "str"

    },
    "ServerStuff\0gotNewMesssage\0\0msg\0"
    "ClientDisconnected\0newConnection\0"
    "readClient\0gotDisconnection\0sendToClient\0"
    "QTcpSocket*\0socket\0str"
};
...
void ServerStuff::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerStuff::ClientDisconnected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ServerStuff::ClientDisconnected()
{
